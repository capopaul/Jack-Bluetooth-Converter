...
static void bt_app_av_state_unconnected_hdlr(uint16_t event, void *param)
{
    ...
    {
        // One outgoing attempt per boot; restart the ESP32 to try again.
        break;
    }
...
static void bt_app_av_state_connecting_hdlr(uint16_t event, void *param)
{
    ...
    case ESP_A2D_CONNECTION_STATE_EVT:
    {
        ...
        else if (a2d->conn_stat.state == ESP_A2D_CONNECTION_STATE_DISCONNECTED)
        {
            ...
            ESP_LOGW(BT_AV_TAG, "Connection failed; automatic retry disabled. Restart to try again.");
        }
        break;
    }
    case ESP_A2D_AUDIO_STATE_EVT:
    ...
    case ESP_A2D_MEDIA_CTRL_ACK_EVT:
        break;
    case BT_APP_HEART_BEAT_EVT:
        // Wait for the connection result; do not schedule another attempt.
        break;
    case ESP_A2D_REPORT_SNK_DELAY_VALUE_EVT:
    {
        a2d = (esp_a2d_cb_param_t *)(param);
