...
void app_main(void)
{
    ...
    // is_expected(CODEC_TAG, 11, i2c_get(CODEC_ADDR, 11), 0b00000010);
    ...
    // is_expected(CODEC_TAG, 51, i2c_get(CODEC_ADDR, 51), 0b00001111);
    ...
    // is_expected(CODEC_TAG, 65, i2c_get(CODEC_ADDR, 65), 0b00001111);
    ...
    // // Read register 72
    // is_expected(CODEC_TAG, 72, i2c_get(CODEC_ADDR, 72), 0b00000110);
    // // Read register 97
